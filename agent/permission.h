...
class permission_manager {
  public:
    ...
    // Set project root for extrnal directory checks
    ...
    void record_tool_call(const std::string &tool,
  ...
  private:
    ...
    std::map<std::string, permission_state> session_override_;
  ...
  public:
    ...
    // Check if a path is outside working directory
