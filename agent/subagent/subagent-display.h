...
public:
  ...
  public:
    ...
    scope(subagent_display &display, const std::string &name,
          subagent_type type, const std::string &description);
  ...
  private:
    ...
    subagent_output_buffer *buffer_ = nullptr; // nullptr for direct mode
    int depth_;
